                                ...
                                <div class="row">
                                    <div class="col-md-3 col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="3K 591" class="form-control" name="flightNo"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-xs-6">
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <div style="position: relative;">
                                                <div class="dropdown-toggle form-control wrapper-filter-item"
                                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                                    style="position: relative;">
                                                    <span style="position: absolute;right: 11px;padding: 4px;"><i
                                                            class="fa fa-sort-up"></i></span>
                                                ...
                                                <ul class="dropdown-menu wrapper-FGlist-item" style="width: 100%">
                                                    <div style="padding-top: 0px; padding: 12px;">
                                                        <span>
                                                            <input style="border-radius: 2px;" id="searchAgent"
                                                                type="text" class="form-control" onkeyup="AgentFilter()"
                                                                placeholder="Type for search..">
                                                        </span>
                                                        <div style="max-height: 218px; overflow: auto;">
                                                            <ul id="ticketing_agent" class="list-unstyled"
                                                                ...
                                                                @foreach (App\Supplier::where(['business_id' => 37, 'supplier_status' => 1])->orderBy('supplier_name')->get() as $key => $sup)
                                                                    <li style="padding: 0px"
                                                                        ...
                                                                        <label style="width: 100%; font-weight: 400">
                                                                            <input style="top: 2px; position: relative;"
                                                                                type="checkbox" name="flightAgent[]"
                                                                                value="{{ $sup->id }}">
                                                                            {{ $sup->supplier_name }}
                                                                        </label>
                                                                    </li>
                                                        ...
                                                        <div><a
                                                                href="{{ route('getSupplierForm', ['type' => 'ticketing-agent']) }}"><i
                                    ...
                                    <div class="col-md-3 col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="dep_time" class="form-control"
                                    ...
                                    <div class="col-md-3 col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="arr_time" class="form-control"
                                    ...
                                    <div class="col-md-6 col-xs-6">
                                        <div class="form-group">
                                            ...
                                            @foreach (App\WeekDay::orderBy('id', 'ASC')->get() as $key => $day)
                                                <input id="checkday{{ $key }}" name="weekday[]" type="checkbox"
                                                    value="{{ $day->id }}"
                                                    style="position: relative;top:4px; width: 16px; height: 16px;">
                                                <label class="label label-default"
                                                    for="checkday{{ $key }}">{{ $day->days_name }}</label>
                                            @endforeach
                                        </div>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $(document).on("click", "ul.wrapper-FGlist-item ul li", function() {
                $(this).closest('ul div div').closest('ul.wrapper-FGlist-item').closest('div').find(
                    'ul#MainUl li:last-child').after('<li><span>' + $(this).data('name') +
                    '</span></li>');
            });
        });
