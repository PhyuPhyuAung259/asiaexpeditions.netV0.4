...
@section('title', 'Tour Booking Form')
<?php 
...
@section('content')
	...
	<table class="table" style="width: 100%;" >
				...
				<td style="border-top: none" colspan="2">
					<div class="well" style="padding: 4px;margin-bottom: 0px; background-color: #ddd0;">
						<address style="margin-bottom: 0px;">
							<i class="glyphicon glyphicon-user"></i>&nbsp;&nbsp;<input type="text" ><br>
						 	<i class="glyphicon glyphicon-home"></i>&nbsp;&nbsp;<input type="text"><br>
							<i class="glyphicon glyphicon-phone-alt"></i>&nbsp;&nbsp;<input type="phone"><br>
							<i class="glyphicon glyphicon-envelope"></i>&nbsp;&nbsp;<input type="email"><br>
						</address>
					</div>
				</td>
			</tr>
			...
			<tr><td><strong>Tour Date</strong>:</td><td class="text-left">{{ Content::dateformat($book['book_checkin'])}}</td></tr>
