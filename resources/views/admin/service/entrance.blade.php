    ...
    <section class="content"> 
      <div class="row">
        <section class="col-lg-12 connectedSortable">
          <h3 class="border">Entrance Fees List <span class="fa fa-angle-double-right"></span> <a href="#" class="btn btn-default btn-sm" id="addMiscService" data-title="Add Entrance Fees" data-toggle="modal" data-target="#myModal">Add Entrance Fees</a></h3>
            <form action="" method="">
            ...
            <table class="datatable table table-hover table-striped">
              ...
              <tbody>
                @foreach($entrance as $rest)
                <tr>
                  <td>{{$rest->name}}</td>
                  <!-- <td>{{{$rest->country->country_name or ''}}}</td>          -->
                  ...
                  <td class="text-right">                      
                    <button style="padding:0px; border:none;" data-title="Update Entrance Fees" class="miscEdit" data-id="{{$rest->id}}" data-country="{{$rest->country_id}}" data-province="{{$rest->province_id}}"  data-title="{{$rest->name}}" data-price="{{$rest->price}}" data-kprice="{{$rest->kprice}}" data-toggle="modal" data-target="#myModal">
                      <i style="padding:1px 2px;" class="btn btn-info btn-xs fa fa-pencil-square-o"></i>
                    </button>
                    <a href="javascript:void(0)" class="RemoveHotelRate" data-type="delEntrance" data-id="{{$rest->id}}" title="Remove this?">
...
<div class="modal fade" id="myModal" role="dialog"  data-backdrop="static" data-keyboard="true">
  <div class="modal-dialog modal-md">    
    <form id="form_submitEtrance" method="POST" action="{{route('addEntrance')}}">
      <div class="modal-content">        
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><strong id="form_title">Add Entrance Service</strong></h4>
        </div>
          ...
          <div class="row">
            <div class="col-md-6 col-xs-6">
              <div class="form-group">
                ...
                <select class="form-control country" id="country" name="country" data-type="entrance" required>
            ...
            <div class="col-md-6 col-xs-6">
              <div class="form-group">
                ...
                <select class="form-control province" name="city" data-type="transport_service" id="dropdown-entrance" required>
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-success btn-flat btn-sm" id="btnEntrance">Publish</button>
