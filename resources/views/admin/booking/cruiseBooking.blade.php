    ...
    <div class="content-wrapper">
      <section class="content"> 
        <div class="row">
          ...
          <div class="col-lg-12"><h3 class="border">Cruise Booking</h3></div>
                  ...
                  <div class="row">
                    <div class="col-md-3 col-xs-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="from_date" name="book_start" value="{{$book->book_checkin}}"  placeholder="Tour Date" required >
                      </div> 
                    </div>
                    <div class="col-md-3 col-xs-12">
                      <div class="form-group">
                    ...
                    <div class="col-md-3 col-xs-6">
                      <div class="form-group">
                        ...
                        <select class="form-control book_City" name="city" id="dropdown-data" data-type="cruise">
                    ...
                    <div class="col-md-3 col-xs-6">
                      <div class="form-group">
                        ...
                        <select class="form-control booking_name" name="cruise_name" id="dropdown-booking"  data-type="river-cruise" required>
                          @foreach(App\Supplier::where(['supplier_status'=>1, 'business_id'=> 3, 'province_id'=> $book->province_id])->orderBy('supplier_name')->get() as $sup)
                            <option value="{{$sup->id}}" {{$sup->id==$book->cruise_id?'selected':''}}>{{$sup->supplier_name}}</option>
                          @endforeach
                        </select>
                      </div> 
                    </div>
                    <div class="col-md-3 col-xs-6">
                      <div class="form-group">
                        <label>Cruise Program<span style="color:#b12f1f;">*</span></label>
                        <select class="form-control booking_name" name="cruise_program" id="dropdown-Cruise_program"  required>
                          @foreach(App\CrProgram::where(['supplier_id'=> $book->cruise_id, 'status'=>1])->orderBy('program_name', 'ASC')->get() as $sup)
                            <option value="{{$sup->id}}" {{$sup->id==$book->program_id?'selected':''}}>{{$sup->program_name}}</option>
                          @endforeach
                        </select>
                      </div> 
                    </div>
