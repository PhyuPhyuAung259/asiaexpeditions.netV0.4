        ...
        <div class="content-wrapper">
            <section class="content">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h3 class="border">Country Management</h3>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input autofocus="" type="text" class="form-control" name="province_name"
                                                value="{{ $province->province_name }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="country">
                                                ...
                                                @foreach (App\Country::where('country_status', 1)->orderBy('country_name', 'ASC')->get() as $key => $con)
                                                    <option value="{{ $province->country_id }}"
                                                        {{ $province->country_id == $con->id ? 'selected' : $province->country_id }}>
                                    ...
                                    <div class="col-md-3 col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <label style="font-weight:400;"> <input type="radio" name="status"
                                                    value="1"
                                                    {{ $province->province_status == 1 ? 'checked' : '' }}>Publish</label>&nbsp;&nbsp;
                                            <label style="font-weight: 400;"> <input type="radio" name="status"
                                                    value="0"
                                                    {{ $province->province_status == 0 ? 'checked' : '' }}>UnPublish</label>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <label style="font-weight:400;"> <input type="radio" name="web"
                                                    value="1"
                                                    {{ $province->web == 1 ? 'checked' : '' }}>Yes</label>&nbsp;&nbsp;
                                            <label style="font-weight: 400;"> <input type="radio" name="web"
                                                    value="0" {{ $province->web == 0 ? 'checked' : '' }}>No</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div id="wrap-feature-image" style="position:relative;"
                                        class="{{ $province->province_photo ? 'open-img' : '' }}">
                                        <input type="hidden" name="user_id" value="{{ $province->user_id }}">
                                        <input type="hidden" name="image" id="data-img"
                                            value="{{ $province->province_photo }}">
                                        <img id="feature-img"
                                            src="{{ Content::urlthumbnail($province->province_photo, $province->user_id) }}"
                                    ...
                                    <a href="#uploadfile" class="btnUploadFiles" data-type="single-img" data-toggle="modal"
                                        data-target="#myUpload">Set Feature Image</a>
                                </div>
                                        ...
                                        <ul class="list-ustyled">
                                            @if ($gallery[0])
                                                @foreach ($gallery as $key => $img)
                                                    <li data-url="{{ $img }}"><i
                                                            class="removegallery fa fa-remove (alias)"
                                                            title="Remove picture" style="display:none;"></i>
                                                        <input type="hidden" name="gallery[]" value="{{ $img }}">
                                                        <img src="{{ Content::urlthumbnail($img, $province->user_id) }}"
                                                            style='width:100%;' />
                                                    </li>
                                                @endforeach
                                            @endif
