    ...
    <div class="content-wrapper">
      <section class="content"> 
        @include('admin.include.message')
          <h3 class="border text-center" style="color:black;text-transform: uppercase;font-weight:bold;">Journal Entry For Office Supplier</h3>
          <div class="container ">
            <div class="col-md-12">
              <div class="pull-left"> 
              ...
              <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="all">
                  <div class="searching">
                    <div id="search_form" style="padding: 6px;border: solid #d2d6de 1px; display: none; position: relative; background: #e8f1ff;margin: 12px 0px;border-radius: 3px;" class="alert alert-dismissible fade in" role="alert"> 
                      ...
                      <form method="GET" action="">
                        <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <input type="text" name="from_date" class="form-control input-sm" id="from_date">
                          </div>
                        </div>
                        <div class="col-md-2">
                          <div class="form-group">
                            <label>End Date</label>
                            <input type="text" name="to_date" class="form-control input-sm" id="to_date">
                          </div>
                        </div>
                        <div class="col-md-5">
                          <div class="form-group">
                  ...
                  <table class="table table-striped table-borderd table-hover">
                    <thead>
                      <tr>
                        ...
                        <th width="10px"><a href="#">Operation</a></th>
                    ...
                    <tbody>
                      @foreach($OfficeSupplier as $acc)
                        <?php $acc_journal = \App\AccountJournal::where(['supplier_id'=> $acc->supplier_id, 'status'=>1]);
                        ...
                        <tr>
                          ...
                          <td>
                            <a target="_blank" href="{{route('getJournalReport', ['office_supplier' => $acc->supplier_id])}}"><label style="cursor:pointer; height: 16px; width: 16px;" class="icon-list ic_inclusion" title="Preview & Edit Journal Entry"> </label></a>
                          </td>                        
                          <td><a target="_blank" href="{{route('getJournalReport', ['office_supplier_report' => $acc->supplier_id])}}">{{{ $acc->supplier->supplier_name or ''}}}</a></td>
