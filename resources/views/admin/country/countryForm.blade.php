                  ...
                  <div class="row">
                    <div class="col-md-6 col-xs-12">
                      <div class="form-group">
                        ...
                        <input autofocus="" type="text" placeholder="Country Name" class="form-control" name="name" required>
                      </div> 
                    </div>
                    <div class="col-md-3 col-xs-12">
                      <div class="form-group">
                        <label>Country Title<span style="color:#b12f1f;">*</span></label> 
                        <input autofocus="" type="text" class="form-control" name="country_title"  required>
                      </div> 
                    </div>
                    <div class="col-md-3 col-xs-12">
                      <div class="form-group">
