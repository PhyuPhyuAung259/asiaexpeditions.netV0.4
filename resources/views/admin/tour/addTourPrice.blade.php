    ...
    <section class="content"> 
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
            ...
            <form action="{{route('addTourPrice')}}" method="POST">
              ...
              <table class="table table-hover table-striped" id="hotel-rate">
                ...
                <tbody>
                  <tr>
                    <td><input name="pax_no[]" value="{{$PaxNo}}" placeholder="Pax 1" type="text" class="form-control input-sm number_only" required ></td>
                    ...
                    <td><span class="btn btn-info btn-xs addHotelRate" data-type="tourrate"><i class="fa fa-plus-circle"></i> Add new</span></td>
                  </tr>               
                </tbody>
              </table>  
