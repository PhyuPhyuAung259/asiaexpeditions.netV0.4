...
<head>
	...
	<title>Contact Us - Asia Expeditions </title>
</head>
				...
				<tr>
					<td valign="TOP">
						<ul style="list-style: none; padding-left: 0px">
							...
							<li style="padding: 4px"><strong>Date:</strong>  {{Content::dateformat($data->created_at)}} </li>
							<li style="padding: 4px"><div><strong>Message </strong></div>
								<p>{!! $data->message !!}</p>
							</li>
						</ul>
					</td>
